...
pdfExportImage.Load(Path.GetFullPath(@"Data/Barcode.pdf"));
...
//Create file stream.
using (FileStream outputFileStream = new FileStream(Path.GetFullPath(@"Output/Output.jpg"), FileMode.Create, FileAccess.ReadWrite))
{
