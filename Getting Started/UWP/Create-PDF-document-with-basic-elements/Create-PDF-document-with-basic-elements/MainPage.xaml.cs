...
namespace Create_PDF_document_with_basic_elements
{
    /// <summary>
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            Stream imageStream = typeof(MainPage).GetTypeInfo().Assembly.GetManifestResourceStream("Create_PDF_document_with_basic_elements.Assets.logo.jpg");
    ...
    internal sealed class Orders
    {
        public static IEnumerable<CustOrders> GetProducts()
        {
            ...
            Stream xmlStream = typeof(MainPage).GetTypeInfo().Assembly.GetManifestResourceStream("Create_PDF_document_with_basic_elements.Assets.Products.xml");
