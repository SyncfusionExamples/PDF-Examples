...
using Create_PDF_document_with_basic_elements.Models;
...
namespace Create_PDF_document_with_basic_elements.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult GenerateInvoice()
        {
            ...
            FileStream imageStream = new FileStream(_hostingEnvironment.WebRootPath + "/Data/logo.jpg", FileMode.Open, FileAccess.Read);
            ...
            FileStream xmlStream = new FileStream(_hostingEnvironment.WebRootPath + "/Data/Products.xml", FileMode.Open, FileAccess.Read);
            ...
            FileStream shipStream = new FileStream(_hostingEnvironment.WebRootPath + "/Data/Products.xml", FileMode.Open, FileAccess.Read);
