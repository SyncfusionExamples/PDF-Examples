...
namespace CreatePDFSample
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        private void CreatePdf_Click(object sender, RoutedEventArgs e)
        {
            ...
            //Set the page orientation and margin. 
            ...
            Stream imgStream = typeof(MainWindow).GetTypeInfo().Assembly.GetManifestResourceStream("CreatePDFSample.Assets.logo.jpg");
            ...
            string filePath = "D://Temp//InvoicePDF.pdf";
    ...
    internal sealed class Orders
    {
        ...
        {
            Stream xmlStream = typeof(MainWindow).GetTypeInfo().Assembly.GetManifestResourceStream("CreatePDFSample.Assets.Products.xml");
