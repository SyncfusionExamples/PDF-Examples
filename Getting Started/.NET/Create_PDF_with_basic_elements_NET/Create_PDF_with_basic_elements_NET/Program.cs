...
namespace Create_PDF_with_basic_elements_NET
{
    internal class Program
    {
        static string shipName, address, shipCity, shipCountry;
        ...
        public static void GetShipDetails(IEnumerable<ShipDetails> details)
        {
        ...
        public static void GetTotalPrice(IEnumerable<CustOrders> orders)
        {
